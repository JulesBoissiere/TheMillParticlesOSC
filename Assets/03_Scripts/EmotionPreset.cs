...
public class EmotionPreset
{
    ...
    public static EmotionPreset interpPreset(Vector2 coords)
    {
        ...
        EmotionPreset[] emotions = new EmotionPreset[8];

        emotions[0] = getCalm();
        emotions[1] = getJoy();
        emotions[2] = getSad();
        emotions[3] = getAnger();
        emotions[4] = getMidJoy();
        emotions[5] = getMidCalm();
        emotions[6] = getMidSad();
        emotions[7] = getMidAnger(); 
    ...
    public static EmotionPreset getMidJoy()
    {
        EmotionPreset preset = new EmotionPreset();
        preset.ShapePos = new Vector3(0, 0, 1500);
        preset.Color1 = new Vector3(1, 1, 0);
        preset.Color2 = new Vector3(1, 0, 0);
        preset.VeloLin = new Vector3(0, 0, 0);
        preset.VeloOrb = new Vector3(0.98f, 0.38f, 0.15f);
        preset.VeloRad = 30;
        preset.VeloSpd = 2;
        preset.VeloLimSpd = 0;
        preset.VeloDmp = 0;
        preset.NoiseStr = new Vector3(0, -60, 0);
        ...
        preset.EmoCoords = new Vector2(0.5f,0.5f);
    ...
    public static EmotionPreset getMidCalm()
    {
        EmotionPreset preset = new EmotionPreset();
        preset.ShapePos = new Vector3(0, 0, 1000);
        preset.Color1 = new Vector3(1, 1, 1);
        preset.Color2 = new Vector3(1, 0, 0);
        preset.VeloLin = new Vector3(0, 0, 0);
        preset.VeloOrb = new Vector3(0.98f, 0.87f, 0);
        preset.VeloRad = 0;
        ...
        preset.VeloLimSpd = 0;
        preset.VeloDmp = 0;
        preset.NoiseStr = new Vector3(100, 0, 00);
        preset.NoiseFrq = 0.0047f;
        preset.NoiseSpd = 0;
        preset.NoisePos = 20;
        preset.NoiseRot = 1;
    ...
    public static EmotionPreset getMidSad()
    {
        EmotionPreset preset = new EmotionPreset();
        preset.ShapePos = new Vector3(0, 0, 850);
        preset.Color1 = new Vector3(0.1f, 0.11f, 0.5f);
        ...
        preset.VeloLimSpd = 0;
        preset.VeloDmp = 0;
        preset.NoiseStr = new Vector3(-56, 0, 0);
        preset.NoiseFrq = 0.0014f;
        preset.NoiseSpd = 10;
        preset.NoisePos = -18;
        preset.NoiseRot = 0;
        preset.NoiseScl = 0.5f;
    ...
    public static EmotionPreset getMidAnger()
    {
        EmotionPreset preset = new EmotionPreset();
        preset.ShapePos = new Vector3(0, 0, 800);
